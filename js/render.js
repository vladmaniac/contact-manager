...
Render.prototype = {
  ...
  sendToForm: function Render_sendToForm(aContact) {
    ...
    document.getElementById("birth-field").value = aContact.birthday;
    document.getElementById("address-field").value = aContact.optionalAddress;
  },

  // Update the UI after editing a contact
  updateUi: function Render_updateUi(aId, aName, aMail, aBirthday, aAddress) {
    var name,
      email,
      birth,
      address;
    ...
    birth = document.getElementById("birth-field" + aId);
  ...
  saveButton: function Render_saveButton(aContact) {
    ...
    saveButton.addEventListener("click", function () {
      ...
      newBirthday = document.getElementById("birth-field").value;
      newAddress = document.getElementById("address-field").value;

      // XXX: not done yet
      manager.editContact(aContact.id, newName, newEmail, newBirthday, newAddress);
